...
// Set an IP string and store it in the buffer. This method assumes you've already validated the IP and it's sane
...
IpDecoder.prototype.set6 = function(ip) {
  ...
  // IPv6 allows collapsing empty parts. So if we have less than we expected, chuck extra colons in there to fill the gaps
  if (bits.length < 8) {
